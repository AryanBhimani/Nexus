package com.ABMTechnoConsultants.nexus.presentation.CommunitiesScreen
...
fun CommunitiesScreen(){
    ...
    val sampleCommunities = listOf(
        Communities(
            ...
            name = "AMB Techno Consultants",
            memberCount ="500M membrs",
        ),
        Communities(
            image = R.drawable.meta,
            name = "AMB Techno Consultants",
    ...
    Scaffold (topBar = {
        ...
        Column(modifier = Modifier.padding(it)) {
            Button(
                ...
                Text(text = "Start a new communities", fontSize = 16.sp, fontWeight = FontWeight.Bold)
            }
